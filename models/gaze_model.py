...
class GazeModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netGazeNetwork = networks.define_GazeNetwork(opt.netG, opt.backbone, opt.ngf, gpu_ids=self.gpu_ids)
    ...
    def set_input(self, input):
        ...
        if "gaze" in input:
            self.gaze = input["gaze"]
    def forward(self):
        """Run forward pass. This will be called by both functions <optimize_parameters> and <test>."""
        
        self.output = self.netGazeNetwork(self.net_input)  # generate output image given the input data_A
